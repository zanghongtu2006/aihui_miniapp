	...
	<view class="main">
		...
		<view class="main_bar">
			...
			<swiper class="swiper" indicator-active-color="#ff5500" :indicator-dots="true" :autoplay="false"
				...
				<swiper-item>
					...
					<view @click="gototypelist(1,'游戏开黑')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/youxi.png')" mode="aspectFit">
							</image>
						</view>
						<text>游戏开黑</text>
					</view>

					<view @click="gototypelist(2,'约饭')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/meishi.png')" mode="aspectFit">
							</image>
						</view>
						<text>约饭</text>
					</view>

					<view @click="gototypelist(3,'看电影')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/dianyin.png')" mode="aspectFit">
							</image>
						</view>
						<text>看电影</text>
					</view>

					<view @click="gototypelist(4,'酒吧蹦迪')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/jiuba.png')" mode="aspectFit">
							</image>
						</view>
						<text>酒吧蹦迪</text>
					</view>

					<view @click="gototypelist(5,'外出游玩')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/lvyou.png')" mode="aspectFit">
							</image>
						</view>
						<text>外出游玩</text>
					</view>

					<view @click="gototypelist(6,'运动')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/yundong.png')" mode="aspectFit">
							</image>
						</view>
						<text>运动</text>
					</view>

					<view @click="gototypelist(7,'街拍摄影')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/sheying.png')" mode="aspectFit">
							</image>
						</view>
						<text>街拍摄影</text>
					</view>

					<view @click="gototypelist(8,'卡拉OK')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/changge.png')" mode="aspectFit">
							</image>
						</view>
						<text>卡拉OK</text>
					</view>

					<view @click="gototypelist(9,'剧本杀')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/jben.png')" mode="aspectFit">
							</image>
						</view>
						<text>剧本杀</text>
					</view>

					<view @click="gototypelist(10,'看话剧')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/huaju.png')" mode="aspectFit">
							</image>
						</view>
						<text>看话剧</text>
					</view>
				...
				<swiper-item>
					...
					<view @click="gototypelist(11,'艺术展')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/yishu.png')" mode="aspectFit">
							</image>
						</view>
						<text>艺术展</text>
					</view>

					<view @click="gototypelist(12,'狼人杀')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/langren.png')" mode="aspectFit">
							</image>
						</view>
						<text>狼人杀</text>
					</view>

					<view @click="gototypelist(13,'游泳')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/youyong.png')" mode="aspectFit">
							</image>
						</view>
						<text>游泳</text>
					</view>

					<view @click="gototypelist(14,'真人cs')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/zrcs.png')" mode="aspectFit">
							</image>
						</view>
						<text>真人cs</text>
					</view>

					<view @click="gototypelist(15,'滑板')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/huaban.png')" mode="aspectFit">
							</image>
						</view>
						<text>滑板</text>
					</view>

					<view @click="gototypelist(16,'演唱会')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/yanchang.png')" mode="aspectFit">
							</image>
						</view>
						<text>演唱会</text>
					</view>

					<view @click="gototypelist(17,'卡丁车')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/kdc.png')" mode="aspectFit">
							</image>
						</view>
						<text>卡丁车</text>
					</view>

					<view @click="gototypelist(18,'爬山')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/shan.png')" mode="aspectFit">
							</image>
						</view>
						<text>爬山</text>
					</view>

					<view @click="gototypelist(19,'图书馆')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/tushug.png')" mode="aspectFit">
							</image>
						</view>
						<text>图书馆</text>
					</view>

					<view @click="gototypelist(20,'其他')" class="main_bar_info">
						<view>
							<image class="main_bar_info_img" :src="geturl('system/zuju/kafei.png')" mode="aspectFit">
							</image>
						</view>
						<text>其他</text>
					</view>
		...
		<view class="main_param">
			...
			<view class="main_param_right">
				<u-tag @click="selectsex()" text="性别" mode="light" shape="circle" bg-color="#EFF9FE" color="#8FD3F5"
					border-color="#EFF9FE" />
				<!-- 运动-->
				<u-tag @click="selecttype()" style="margin-left:10rpx;" text="类型" mode="light" shape="circle"
