	...
	<view>
		...
		<view class="main">
			...
			<view class="row_input">
				<u-input v-model="value" :placeholder="placehold()" :custom-style="{'caret-color': '#303133','color':'#808080'}" placeholder-style="color:#8f8f8f;"
				 :maxlength="length" :clearable="false" />
			</view>
